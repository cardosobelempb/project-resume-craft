...
import { ResumeArraykeys, ResumeMultipleDragListItemData } from "./resume-multiple-drag-list"
...
export const ManageMultipleItemDialog: React.FC<ManageMultipleItemDialog> = ({data, open, setOpen}) => {
        ...
        return config.map((field, index) => {
            ...
            return (
                <Fragment key={index}>
                    ...
                    {fieldType === "slider" && <EditorField {...inputProps}/>}
                    {fieldType === "keywords" && <EditorField {...inputProps}/>}
                </Fragment>
            )
        })
    }, [data.formKey])
