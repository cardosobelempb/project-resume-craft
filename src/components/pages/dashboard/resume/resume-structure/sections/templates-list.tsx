...
import { TemplatesProps } from "@/components/shared/types/templates"
import { Controller, useFormContext } from "react-hook-form"
import { cn } from "@/lib/utils"
import Image from "next/image"

const allTemplates: TemplatesProps[] = ["eevee", "ditto", "jynx", "onix"]
                    ...
                    return (
                        ...
                        >
                            <Image
                                ...
                                width={150}
                                height={130}
                                src={`/image/templates/${template}.webp`}
                                alt={template}
                            />
                        <div className="absolute text-sm inset-0 w-full h-full flex flex-col font-bold font-title capitalize items-center justify-center p-2 bg-gradient-to-t from-background">{template}</div>
                        </button>
                    )
                })}
            </div>
